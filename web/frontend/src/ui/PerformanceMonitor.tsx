  ...
  return (
    <Show when={dataStore.state.currentView === 'node_view'}>
      ...
      <button
        ...
        class="fixed bottom-4 left-4 z-50 bg-black bg-opacity-50 text-white p-2 rounded-lg hover:bg-opacity-70 transition-all"
      ...
      <Show when={showMonitor()}>
        <div class="fixed bottom-16 left-4 z-50 bg-black bg-opacity-70 text-white p-3 rounded-lg text-sm">
