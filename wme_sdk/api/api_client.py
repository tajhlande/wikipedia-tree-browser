...
class Client:
    ...
    def _download_entity(
        self, path: str, writer: io.BytesIO, tracker: Optional[ProgressTracker] = None
    ):
        ...
        def download_chunk(start, end):
            ...
            tracker.update(end - start) if tracker else None
    ...
    def download_batch(
        ...
        self._download_entity(
            f"{self._get_batches_prefix(time)}/{idr}/download", writer, tracker
        )
    ...
    def download_snapshot(
        self, idr: str, writer: io.BytesIO, tracker: Optional[ProgressTracker] = None
    ):
    ...
    def download_structured_snapshot(
        self, idr: str, writer: io.BytesIO, tracker: Optional[ProgressTracker] = None
    ):
        self._download_entity(
            f"snapshots/structured-contents/{idr}/download", writer, tracker
        )
